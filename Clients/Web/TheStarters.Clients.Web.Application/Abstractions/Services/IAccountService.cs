...
{
    public Task<IResult<SelfRegisterResponse>> SelfRegisterAsync(SelfRegisterRequest request);
...
public record struct SelfRegisterResponse(string UserId, string Email, string Name);
